...
class NetworkModule(
    ...
    @Singleton
    @Provides
    fun provideAuthInterceptor(authenticationLocalDataSource: AuthenticationLocalDataSource): AuthInterceptor {
        return AuthInterceptor(consumerKey, consumerSecret, authenticationLocalDataSource)
    }
